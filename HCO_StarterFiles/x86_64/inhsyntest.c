...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 inhsyntest /Users/imagining/Documents/NIH_BRAIN/HCO_StarterFiles/x86_64/inhsyntest.mod\n");
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t; {
   double _lx ;
 _lx = _args[0] ;
   state_discontinuity ( _cvode_ieq + 0, & Ag , Ag + _lx ) ;
   state_discontinuity ( _cvode_ieq + 1, & Bg , Bg + _lx ) ;
   } }
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 66 in file inhsyntest.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
