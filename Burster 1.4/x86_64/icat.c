...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 4);
 	...
 	ivoc_help("help ?1 cat /Users/imagining/Documents/NIH_BRAIN/Burster 1.4/x86_64/icat.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    uinf = 1.0 / ( 1.0 + ( exp ( - ( _lv + 25.0 ) / ( 7.2 ) ) ) ) ;
   utau = ( 55.0 - 49.5 / ( 1.0 + ( exp ( - ( _lv + 58.0 ) / ( 17.0 ) ) ) ) ) ;
   zinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 36.0 ) / ( 7.0 ) ) ) ) ;
   ztau = ( 87.5 - 75.0 / ( 1.0 + ( exp ( - ( _lv + 50.0 ) / ( 16.9 ) ) ) ) ) ;
     return 0; }
