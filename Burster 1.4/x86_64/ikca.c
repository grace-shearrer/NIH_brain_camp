...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 12, 5);
 	...
 	ivoc_help("help ?1 kca /Users/imagining/Documents/NIH_BRAIN/Burster 1.4/x86_64/ikca.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lcasi ) {
    cinf = ( ( _lcasi ) / ( _lcasi + 0.030 ) ) * ( ( 1.0 ) / ( 1.0 + ( exp ( - ( _lv + 51.0 ) / ( 4.0 ) ) ) ) ) ;
   ctau = ( ( 90.3 ) - ( 75.09 ) / ( 1.0 + ( exp ( - ( _lv + 46.0 ) / ( 22.7 ) ) ) ) ) ;
     return 0; }
