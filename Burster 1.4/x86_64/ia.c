...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 4);
 	...
 	ivoc_help("help ?1 kA /Users/imagining/Documents/NIH_BRAIN/Burster 1.4/x86_64/ia.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
    uinf = ( 1.0 ) / ( 1.0 + ( exp ( - ( _lv + 27.0 ) / ( 8.7 ) ) ) ) ;
   utau = ( ( 11.6 ) - ( 10.4 ) / ( 1.0 + ( exp ( - ( _lv + 32.9 ) / ( 15.2 ) ) ) ) ) ;
   zinf = 1.0 / ( 1.0 + ( exp ( ( _lv + 56.9 ) / ( 4.9 ) ) ) ) ;
   ztau = ( 38.6 - 29.2 / ( 1.0 + ( exp ( - ( _lv + 38.9 ) / ( 26.5 ) ) ) ) ) ;
     return 0; }
