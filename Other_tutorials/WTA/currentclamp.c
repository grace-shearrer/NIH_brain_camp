	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 2);
 	...
 	ivoc_help("help ?1 currentclamp /cygdrive/c/Users/nairs/Desktop/AWork in Progress/NEURON Related/EXERCISES using NEURON/ADVANCED NEURON programming exercises/WTA/currentclamp.mod\n");
