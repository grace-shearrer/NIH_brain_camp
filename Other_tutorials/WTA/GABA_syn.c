	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 GABA /cygdrive/c/Users/nairs/Desktop/AWork in Progress/NEURON Related/EXERCISES using NEURON/ADVANCED NEURON programming exercises/WTA/GABA_syn.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 64 in file GABA_syn.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
